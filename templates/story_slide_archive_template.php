...
<body>
	<?php do_shortcode('[storymap_archive slide_category="'.$archive->name.'" fullscreen="true"]'); ?>
	<?php wp_footer(); ?>
	<div class="sm-social-sharing">
	    ...
	    <!-- Twitter -->
	    <a href="https://twitter.com/share?url=<?php echo $post_url; ?>&amp;text=<?php echo $archive->name; ?>&amp;hashtags=storymap" target="_blank">
